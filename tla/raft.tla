--------------------------------- MODULE raft ---------------------------------
\* VENDORED VERBATIM from Vanlightly/raft-tlaplus, commit main branch as of 2026-05-01.
\* Source: specifications/standard-raft/RaftWithReconfigAddRemove.tla
\* Only the MODULE name was changed (RaftWithReconfigAddRemove -> raft) to match
\* the filename. No semantic edits.
\* ---------------------------------------------------------------------------
(* NOTES 
